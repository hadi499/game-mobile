...
// Cheerful pink/pastel color palette
const COLORS = {
  bg: "#FFF0F5",
  bgGradientTop: "#FFF5F9",
  primary: "#FF6B9D",
  primaryDark: "#E5407A",
  primaryLight: "#FFB6D0",
  primarySuperLight: "#FFE0EC",
  accent: "#FFD93D",
  accentDark: "#E6B800",
  white: "#FFFFFF",
  cardBorder: "#FFD6E5",
...
export default function CountingGameScreen() {
  ...
  const nextQuestion = useCallback((qNum: number) => {
  ...
  const handleAnswer = useCallback(
    ...
    [showSuccess, showError, question, questionNumber, nextQuestion],
  );
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <Text style={styles.scoreText}>
              Adik betul <Text style={styles.scoreHighlight}>{score}</Text> dari{" "}
